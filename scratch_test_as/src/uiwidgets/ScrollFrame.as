...
public class ScrollFrame extends Sprite implements DragClient {
	...
	public function setContentsScale(n:Number):void {
		// If content is a ScriptsPane, set its scale. Otherwise, do nothing.
		var pane:ScriptsPane = contents as ScriptsPane;
		if (pane) pane.setScale(n / 100.0);
	}
	...
	public function updateScrollbarVisibility():void {
		...
		shouldShow = visibleW() < contents.width;
