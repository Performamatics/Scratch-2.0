...
public class JSON_AB {
	...
	private function error(msg:String):void { throw new Error(msg + " [pos=" + src.pos()) + "]" }
	...
	private function write(value:*):void {
		...
		if ((value is Number) || (value is Boolean)) buf += value;
