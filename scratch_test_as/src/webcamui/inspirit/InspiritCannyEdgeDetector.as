package webcamui.inspirit
{
	...
	{
		[Embed("Gray.pbj", mimeType="application/octet-stream")] private var Gray:Class;
		[Embed("GaussBlur.pbj", mimeType="application/octet-stream")] private var GaussBlur:Class;
		[Embed("EdgeDiff.pbj", mimeType="application/octet-stream")] private var EdgeDiff:Class;
		[Embed("EdgeMagnitude.pbj", mimeType="application/octet-stream")] private var EdgeMagnitude:Class;
		[Embed("BytesToBitmap.pbj", mimeType="application/octet-stream")] private var BytesToBitmap:Class;
		[Embed("Hysteresis.pbj", mimeType="application/octet-stream")] private var Hysteresis:Class;
		...
		public function InspiritCannyEdgeDetector(image:BitmapData, lowThreshold:Number = 0.01, highThreshold:Number = 0.1)
		{
			this.image = image;
